...
from tiktok.TiktokLogic import tiktok, tiktokHelp
...
def loadExtensions(messengerObject):
    ...
    messengerObject.addExtension(commandName="/tiktok", commandFunction=tiktok, commandHelp=tiktokHelp, files=True)
